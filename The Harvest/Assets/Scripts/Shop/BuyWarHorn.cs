...
public class BuyWarHorn : MonoBehaviour
{
    ...
    void OnMouseOver() {
        if(Input.GetKeyDown(KeyCode.Mouse0) && canBeClicked && !Singleton.instance.hasWarHorn && Singleton.instance.currentShopCurrency >= 3) {
            Singleton.instance.hasWarHorn = true;
